...
def printHelp():
    ...
    print "Examples:"
    print "  ucl gen .. -g java"
    print "  ucl gen icanchangethisdomain/SomeProjectName  #generate with every available generator"
    print "TopologyFilePath can be absolute, relative to current path, or "
    print "relative to projects root path e.g.:"
    print "  ucl gen github.com\\osblinnikov\\generator\\example -g java"
    print ""
    print "Available options:"
    print "  -g {generator folder name e.g java, connector or c}"
